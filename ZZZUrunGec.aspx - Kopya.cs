    ...
    public partial class ZZZUrunGec : System.Web.UI.Page
    {
        ...
        protected void BilgiCek() {
            ...
            if (oku.Read())
            {
                ...
                TXTTLFiyat.Text = FrmtSayi.ToString("N");
                CURR = oku[1].ToString();
            }
            else
            {
            ...
            TXTTLFiyat.Text = Convert.ToDecimal(TXTTLFiyat.Text).ToString("N");
        ...
        protected void KampanyaCheck() {
            ...
            LBLMAx.Text ="Vadeyi Kısa Miktarı Çok Seçerek "+ Convert.ToDecimal((bFiyat * yuzde)*Convert.ToDouble(HFCURRATE.Value)).ToString("N")+" TL den Alabilirsiniz!!!";
          }
        ...
        protected void TXTMik_TextChanged(object sender, EventArgs e)
        {
            ...
            while (oku.Read())
            {
                ...
                if (ksayi<=IMik && IMik<=bsayi)
                {
                    ...
                    TXTTLFiyat.Text = Convert.ToDecimal(TXTTLFiyat.Text).ToString("N");
                    TXTTopTut.Text = Convert.ToDecimal(TXTTopTut.Text).ToString("N");
                    TXTBRF.Text = Convert.ToDecimal((bFiyat * yuzde)).ToString("N") + " €";
