...
var ddimgtooltip={
	...
	tiparray:function(){
		...
		tooltips[0]=["./img/infokoza.png", "M. Temsilciniz: RAFET PARLAK<br /> TEL : 0555 333 6677", {background:"#FFFFFF", color:"4a4c49", border:"6px double #828282"}]
		tooltips[1]=["duck2.gif", "Here is a duck on a light blue background.", {background:"#DDECFF", width:"200px"}]
		tooltips[2]=["./img/info.png"]
