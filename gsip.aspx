        ...
        <asp:Panel ID="PNLNormal" runat="server">
            <asp:Panel ID="PNLTXTler" runat="server">
                <asp:Panel ID="Panel1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; font-size: 13pt;">
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel18">
                                            <ContentTemplate>
                                                <asp:Label ID="LBLAracSinif" runat="server" Text="Araç Seçiniz" Visible="false"></asp:Label>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                    <td style="text-align: center; font-size: 13pt;">Kampanya İncele</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel17">
                                            <ContentTemplate>
                                                <dx:ASPxComboBox ID="CMBAITOZSPE" OnSelectedIndexChanged="CMBAITOZSPE_SelectedIndexChanged" AutoPostBack="true" Height="30" runat="server" DropDownStyle="DropDown" IncrementalFilteringMode="StartsWith"
                                                    Width="150px" Font-Names="Tahoma" Font-Size="11pt" Theme="SoftOrange" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                    <td>
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel5">
                                            <ContentTemplate>
                                                <dx:ASPxComboBox Visible="false" ID="CMBAITOZ" ClientInstanceName="ClientCMBAITOZ" OnSelectedIndexChanged="CMBAITOZ_SelectedIndexChanged1" AutoPostBack="true" Height="30" runat="server" DropDownStyle="DropDown" IncrementalFilteringMode="StartsWith"
                                                    Width="500px" Font-Names="Tahoma" Font-Size="11pt" Theme="SoftOrange" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                    <td>
                                     ...
                                     <td>
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel19">
                                            <ContentTemplate>
                                                <asp:CheckBox ID="CHCKMikKamp" AutoPostBack="true" Font-Size="12pt"  Visible="false" OnCheckedChanged="CHCKMikKamp_CheckedChanged" runat="server" Text="Miktar Kampanyalı Ürünler" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                     <td style="padding-left:10px;">
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel20">
                                            <ContentTemplate>
                                                <asp:CheckBox ID="CHCKSonFiyatKamp" AutoPostBack="true" Font-Size="12pt"  Visible="false" OnCheckedChanged="CHCKSonFiyatKamp_CheckedChanged" runat="server" Text="Özel Kampanyalı Ürünler" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
                    ...
                    <a href="gsipSimple.aspx" class="btn btn-success pull-right">Basit Arama</a>

                </asp:Panel>

            </asp:Panel>
            <asp:Panel ID="PNLCombolar" Visible="true" runat="server">
                <table>
                    <tr>
